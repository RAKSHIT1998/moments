...
struct SignedEvent: Codable, Sendable, Equatable, Identifiable, Hashable {
    enum Kind: String, Codable, Sendable, CaseIterable {
        case profile, moment, momentUpdate, join, leave, contribution, comment, reaction, now, nowJoin, follow, unfollow, report, claim, group, delete, plan, subscribe, grant, tip, seen
    }
